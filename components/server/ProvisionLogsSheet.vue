  ...
  <Sheet v-model:open="open">
    ...
    >
      ...
      <div v-if="server" class="mt-4 flex-1 min-h-0 flex flex-col">
        ...
        <div
          v-if="
            (server.status === 'awaiting_connection' ||
              server.status === 'new') &&
            server.provider === 'custom_server' &&
            server.provision_command
          "
        ...
        >
          ...
          <div
            class="relative flex items-start gap-2 rounded border bg-background p-3 font-mono text-sm"
          >
        ...
        >
          <div
            class="flex flex-shrink-0 items-center justify-between gap-3 border-b border-zinc-800 bg-zinc-900/60 px-3 py-2"
          >
            ...
            <div
              class="flex flex-shrink-0 items-center gap-1.5 text-[10px] uppercase tracking-wider text-zinc-500"
            >
              <span
        ...
        <div
          v-else-if="showLogs && !provisionStatus?.latest_task"
          class="flex-1 min-h-0 flex flex-col items-center justify-center gap-3 rounded-lg border bg-muted/30 py-12"
        >
          <Icon
            name="lucide:loader-2"
        ...
        >
          ...
          <ul v-else-if="provisionStatus?.steps" role="list" class="space-y-0">
            ...
            >
              ...
              <div
                class="relative flex h-6 w-6 flex-none items-center justify-center z-10 rounded-full bg-background"
              >
                ...
                />
                <div v-else class="h-2.5 w-2.5 rounded-full bg-border" />
              </div>
