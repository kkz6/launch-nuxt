...
<template>
  <div class="w-full">
    ...
    <ServerSettingsBackups
      v-if="activeSubTab === 'backups'"
      :server-id="server.id"
    />
    <ServerSettingsSshKeys
      v-if="activeSubTab === 'ssh-keys'"
      :server-id="server.id"
    />
    <ServerSettingsPackages
      v-if="activeSubTab === 'packages'"
      :server-id="server.id"
    />
    <ServerSettingsServices
      v-if="activeSubTab === 'services'"
      :server-id="server.id"
