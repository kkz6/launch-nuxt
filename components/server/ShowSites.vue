  ...
  <div class="space-y-4">
    <Card class="bg-background">
      <CardHeader>
        ...
        <CardDescription
          >Manage sites for {{ server.name }}</CardDescription
        >
      </CardHeader>
      <CardContent class="flex flex-col gap-4">
        ...
        >
          <Globe2 class="h-8 w-8 self-center text-muted-foreground" />
                    ...
                    >
                      <SharedDateTooltip :date="getStatusDate(site)">
                        <SharedInstallationStatus
                          ...
                          :uninstallation_requested_at="
                            site.uninstallation_requested_at
                          "
                          :uninstallation_failed_at="
                            site.uninstallation_failed_at
                          "
                        />
                      </SharedDateTooltip>
                    </div>
