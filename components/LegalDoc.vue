...
<template>
  <section class="relative overflow-hidden bg-[hsl(var(--site-bg))]">
    <div class="site-grid-pattern pointer-events-none absolute inset-0 opacity-[0.5] [mask-image:radial-gradient(ellipse_70%_45%_at_50%_-10%,black,transparent)]" />
    <div class="pointer-events-none absolute inset-0 bg-[radial-gradient(50%_40%_at_80%_-5%,theme(colors.emerald.500/7%),transparent)]" />

    <div class="relative mx-auto max-w-3xl px-6 pb-24 pt-28 lg:px-8 lg:pt-32">
      <div class="border-b border-[hsl(var(--site-border))] pb-8" data-aos="fade-up">
        <span class="font-mono text-xs text-[hsl(var(--site-accent))]"># legal</span>
        ...
        <p v-if="intro" class="mt-5 text-lg leading-relaxed text-[hsl(var(--site-text-muted))]">
          {{ intro }}
        </p>
      </div>
